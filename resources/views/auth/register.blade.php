        ...
        <div class="col-md-8">
            <div class="card">
                <div class="text-center m-2">
                    <h1 class="text-center font-weight-bold">Taxi Drivers</h1>
                    <img src="{{ asset('img/about-img.jpg') }}" width="200" height="150" class="rounded" alt="">
                </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('users.index') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="image" class="col-md-4 col-form-label text-md-end">{{ __('Photograph') }}</label>
                            <div class="col-md-6">
